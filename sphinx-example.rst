...
In the origin repository in the documentation where the documetation source (usually *.rst files) are pushed create a file named ``.github/workflows/publish.yml``:
